...
/** 服务实现类 */
@Service
public class CourseServiceImpl extends AbsServiceImpl<CourseMapper, Course>
    implements CourseService {

  @Override
  public List<Course> sqlSelectList(Course qo) {
  ...
  @Override
  public int sqlUpdate(Course e) {
    return baseMapper.sqlUpdate(e);
  }

  @Override
  public int sqlSave(Course e) {
