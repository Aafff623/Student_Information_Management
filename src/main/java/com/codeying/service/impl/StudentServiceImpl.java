...
/** 服务实现类 */
@Service
public class StudentServiceImpl extends AbsServiceImpl<StudentMapper, Student>
    implements StudentService {

  @Override
  public List<Student> sqlSelectList(Student qo) {
  ...
  @Override
  public int sqlUpdate(Student e) {
    return baseMapper.sqlUpdate(e);
  }

  @Override
  public int sqlSave(Student e) {
